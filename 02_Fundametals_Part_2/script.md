...
rules above (you can check out the code from first tip calculator challenge if you need to).
...
Store the BMI valueto a property, and also return it from the method.
