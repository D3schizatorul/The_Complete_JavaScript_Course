...
const formatCurrency = function (value, account) {
...
const displayMovements = function (account, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const formattedMov = formatCurrency(mov, account);
...
const calcPrintBalance = function (account) {
  ...
  labelBalance.textContent = formatCurrency(balance, account);
};
...
const calcDisplaySummary = function (account) {
  ...
  labelSumOut.textContent = formatCurrency(Math.abs(out), account);
